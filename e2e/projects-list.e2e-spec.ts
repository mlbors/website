...
describe('projects list page', () => {
  ...
  it('should have color for h1', () => {
    ...
    const h1 = page.getH1();
    const ec = ExpectedConditions;
    browser.wait(ec.presenceOf(h1), 52000).then(result => {
  ...
  it('should have color for terms buttons', () => {
    ...
    const ec = ExpectedConditions;
    browser.wait(ec.presenceOf(page.getFirstTermButtonLinks()), 52000).then(result => {
  ...
  it('should have color for project titles', () => {
    ...
    const ec = ExpectedConditions;
    browser.wait(ec.presenceOf(page.getFirstProjectTitle()), 52000).then(result => {
  ...
  it('should have color for projects text', () => {
    ...
    const ec = ExpectedConditions;
    browser.wait(ec.presenceOf(page.getFirstProjectText()), 52000).then(result => {
  ...
  it('should have color for project buttons', () => {
    ...
    const ec = ExpectedConditions;
    browser.wait(ec.presenceOf(page.getFirstProjectButton()), 52000).then(result => {
  ...
  it('should navigate to detail', () => {
    ...
    page.getFirstProjectTitle().getText().then(result => {
      page.getFirstProjectButton().click().then(project => {
        ...
        browser.wait(ec.presenceOf(projectDetailTitle), 52000).then(condition => {
